$.fn.progressScroll=function(e){
    var r = $.extend({ width: 50, height: 50, borderSize: 5, mainBgColor: "#222F43", lightBorderColor: "#0F172A", darkBorderColor: "#eb2810", fontSize: "20px" }, e);
    var t,
        i,
        n,
        o = this,
    ...
    this.updateProgress = function (e) {
        ...
        if (r <= 180) {
            ...
            $("." + s, a).css("background-image", "linear-gradient(" + (r - 90) + "deg, transparent 50%, #eb2810 50%),linear-gradient(90deg, #0F172A 50%, transparent 50%)");
        }
        $("." + l, a).text();
    };
    //e+"%"
